        ...
        <footer className='pt-28'>
          <div className="container max-w-[1000px]">
            ...
            <div className='flex justify-between items-center'>
              <div>
                <p className='text-[15px] text-[#FFFFFF40] leading-[14px] font-light flex items-center'>Proudly Made in India <span className='ml-2 mt-[3px]'><img src="/images/full-sentence.svg" alt="" /></span></p>
                <p className='text-[15px] text-[#FFFFFF40] leading-[14px] font-light mt-3'>All Rights & Wrongs Reserved , 2024</p>
              </div>
              <div>
                <p className='text-[15px] text-[#FFFFFF40] leading-[14px] font-light'>Contact | For Creator | For Business</p>
                <p className='text-[15px] text-[#FFFFFF40] leading-[14px] font-light mt-3'>Terms & Conditions | Privacy Policy |  Disclaimer</p>
              </div>
            </div>
          ...
          <div className="sub-footer mt-10">
            <div className='flex items-center justify-between'>
              ...
              <div className='flex items-center gap-5'>
                <h3 className='text-[17px] text-[#FFFFFF40] leading-[17px] mr-3'>Backed by:</h3>
