...
const JoinOurEcosystem = () => {
  return (
    ...
    <section className='bg-[#0C0C0C] pt-24 pb-8'>
      <div className="container bg-[#30303066] rounded-[20px] max-w-[1100px] relative">
        <div className='relative'>
        <div>
          <img src="/images/bg-gred.svg" alt="" className='absolute rounded-bl-[20px]' />
        </div>
        <div className='relative'>
          <img src="/images/bg-hunt.svg" alt="" className='absolute left-[240px] max-w-[640px] opacity-50' />
        </div>
        </div>
        <div className='py-12 relative z-20 rounded-[20px]'>
